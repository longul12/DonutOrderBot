...
SpawnerProtect. The latest verified work restores the final Order handoff when
SpawnerDrop sees a stop item: Drop pauses, Order sells remaining target items,
then Drop waits for respawn without Order re-enabling Drop.
